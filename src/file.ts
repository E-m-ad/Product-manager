 ...
 * count()
 */
//first we need to get all elements
let nameOfProduct: any = document.getElementById("nameOfProduct");
let priceChildern: any = document.querySelector(".price");
let originalPrice: any = priceChildern?.children[0];
let sellPrice: any = priceChildern?.children[1];
let discount: any = priceChildern?.children[2];
let spanPirce: any = document.querySelector(".totalprice");
let total: any = priceChildern?.children[3];
let count: any = document.getElementById("count");
let gender: any = document.getElementById("Gender");
let createButton: any = document.getElementById("CreateElement");
let table: any = document.querySelector("table");
let allInputs = document.querySelectorAll("input");
let mood = "create";
let tmp;
let searchButton: any = document.getElementById("search");
let searchIcon: any = document.getElementById("searchingIcon");
...
function deleteButton() {
  if (storageArray.length > 0) {
    let button: any = document.getElementById("DeleteButton");
...
//=============================================================================================
//second one
let nameOfNeededElements: any = document.getElementById("nameOfNeeded");
let numberOfNeededElements: any = document.getElementById("numberOfNeeded");
let buttonCreated: any = document.getElementById("neededproductsButtons");
//first function to get date form inputs
let boxArray: any[] = [];
...
//second function we need is to read the data on the screen
